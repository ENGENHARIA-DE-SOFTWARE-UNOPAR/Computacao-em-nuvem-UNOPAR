...
\par Após os ajuste necessarios, foi compilado o exemplo e o resultado da aula prática é observado na figura \ref{fig:result_pratic}

\begin{figure}[h]
  \center
  \includegraphics[width=\textwidth]{figure/result_pratic.jpg}
  \caption{Resultado da aula prática, O autor}
  \label{fig:result_pratic.jpg}
\end{figure}

...
\par As simulações permitem uma prática no aprendizado, e de acordo com \citeonline{Acervolima}, além de proporcionar uma consolidação no aprendizado as simulações vão muito além disto, nós permite testar sistemas antes de sua aplicação, prevendo erros de sistemas e outras sistuações.

...
\par As simulações permitem a prática no aprendizado, e de acordo com \citeonline{Acervolima}, além de proporcionar uma consolidação no aprendizado as simulações vão muito além disto, nós permite testar sistemas antes de sua aplicação, prevendo erros de sistemas e outras situações. Na implementração desta aula prática foi percebido alguns detalhes relevantes, no pré projeto, como configuração do NetBeans para java e inclusão do \verb#.jar#.
